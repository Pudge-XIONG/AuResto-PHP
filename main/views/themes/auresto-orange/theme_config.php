...
$theme['head_tags'] = array(
	'doctype'   => 'html5',
	'favicon'   => theme_url('auresto-orange/images/favicon.ico'),
	'meta'     	=> array(
	...
	'style'    	=> array(
		array(theme_url('auresto-orange/css/bootstrap.min.css'), 'bootstrap-css', '10'),
		array(theme_url('auresto-orange/css/font-awesome.min.css'), 'font-awesome-css', '11'),
		array(theme_url('auresto-orange/css/select2.css'), 'select2-css', '13'),
		array(theme_url('auresto-orange/css/select2-bootstrap.css'), 'select2-bootstrap-css', '14'),
		array(theme_url('auresto-orange/css/jquery.raty.css'), 'jquery-raty-css', '15'),
		array(theme_url('auresto-orange/css/fonts.css'), 'fonts-css', '16'),
		array(theme_url('auresto-orange/css/stylesheet.css'), 'stylesheet-css', '100100100100100'),
	),
	'script'   	=> array(
		array(theme_url('auresto-orange/js/jquery-1.11.2.min.js'), 'jquery-js', '1'),
		array(theme_url('auresto-orange/js/bootstrap.min.js'), 'bootstrap-js', '10'),
		array(theme_url('auresto-orange/js/select2.js'), 'select-2-js', '12'),
		array(theme_url('auresto-orange/js/jquery.raty.js'), 'jquery-raty-js', '13'),
		array(theme_url('auresto-orange/js/common.js'), 'common-js', '100100100100100'),
	),
);
...
/* Location: ./main/views/themes/auresto-orange/theme_config.php */