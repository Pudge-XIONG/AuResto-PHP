        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 wrap-all border-top">
                    <!-- AuResto is open source software developed and maintained by a volunteer community.
                    It would be much appreciated by the AuResto community if you left the full copyright and "powered by" notice intact,
                    to show your support for AuResto.  If you choose to remove or modify the copyright below,
                    you may be refused support on the AuResto Community Forums.

                    This is free software, support us and we'll support you. -->
                    <?php echo sprintf(lang('site_copyright'), date('Y'), config_item('site_name'), lang('auresto_system_name')) . lang('auresto_system_powered'); ?>
                    <!-- End powered by -->
                </div>
            </div>
        </div>
