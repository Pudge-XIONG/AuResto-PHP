<?php
	...
	$auresto_logo  = base_url('views/themes/auresto-blue/images/auresto-logo.png');
	$site_logo          = base_url('views/themes/auresto-blue/images/auresto-logo-text.png');
    $system_name 		= lang('auresto_system_name');
			...
			<div class="navbar-header">
				<div class="navbar-brand">
					<div class="navbar-logo col-xs-3">
						<img class="logo-image" alt="<?php echo $system_name; ?>" title="<?php echo $system_name; ?>" src="<?php echo $auresto_logo; ?>"/>
					</div>
...
<!--							<li><a href="--><?php //echo site_url('uri_routes'); ?><!--">--><?php //echo lang('menu_uri_route'); ?><!--</a></li>-->
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu  dropdown-user">
							...
							<li class="divider"></li>
							<li><a href="http://auresto.com/about/" target="_blank"><i class="fa fa-info-circle fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_about_auresto'); ?></a></li>
							<li><a href="http://docs.auresto.com" target="_blank"><i class="fa fa-book fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_documentation'); ?></a></li>
							<li><a href="http://forum.auresto.com" target="_blank"><i class="fa fa-users fa-fw"></i>&nbsp;&nbsp;<?php echo lang('text_community_support'); ?></a></li>
							<li class="menu-footer"></li>
						</ul>
					</li>
				</ul>
