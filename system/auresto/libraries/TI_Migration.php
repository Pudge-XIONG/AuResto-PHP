...
/**
 * AuResto Migration Class
 *
 * @category       Libraries
 * @package        AuResto\Libraries\TI_Migration.php
...
class TI_Migration extends CI_Migration {
	...
	/**
	 * Install AuResto core schema to the migration version set in config.
	 *
	...
	public function install() {
		...
		// Core Migrations - this is all that is needed for AuResto install.
...
/* Location: ./system/auresto/core/TI_Migration.php */