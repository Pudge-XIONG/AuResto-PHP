 ...
 *
 * @category       Models
 * @package        AuResto\Models\Dashboard_model.php
...
class Dashboard_model extends TI_Model {
	...
	public function getNewsFeed($number = 5, $expiry = 3) {
		...
		$this->feed_parser->set_feed_url('http://feeds.feedburner.com/AuResto');
...
/* Location: ./system/auresto/models/dashboard_model.php */